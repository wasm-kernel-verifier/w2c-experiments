...
static void w2c_0x24loop0x2Ewasm_0x5F_wasm_call_ctors_0(w2c_0x24loop0x2Ewasm*);
static u32 w2c_0x24loop0x2Ewasm_0x5F_original_main_0(w2c_0x24loop0x2Ewasm*);
static u32 w2c_0x24loop0x2Ewasm_main_0(w2c_0x24loop0x2Ewasm*, u32, u32);

FUNC_TYPE_T(w2c_0x24loop0x2Ewasm_t0) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";
FUNC_TYPE_T(w2c_0x24loop0x2Ewasm_t1) = "\x72\xab\x00\xdf\x20\x3d\xce\xa1\xf2\x29\xc7\x9d\x13\x40\x7e\x98\xac\x7d\x41\x4a\x53\x2e\x42\x42\x61\x55\x2e\xaa\xeb\xbe\xc6\x35";
FUNC_TYPE_T(w2c_0x24loop0x2Ewasm_t2) = "\x92\xfb\x6a\xdf\x49\x07\x0a\x83\xbe\x08\x02\x68\xcd\xf6\x95\x27\x4a\xc2\xf3\xe5\xe4\x7d\x29\x49\xe8\xed\x42\x92\x6a\x9d\xda\xf0";

static void init_globals(w2c_0x24loop0x2Ewasm* instance) {
...
static void init_memories(w2c_0x24loop0x2Ewasm* instance) {
  wasm_rt_allocate_memory(&instance->w2c_memory, 2, 65536, 0, 65536);
}

static void init_tables(w2c_0x24loop0x2Ewasm* instance) {
  wasm_rt_allocate_funcref_table(&instance->w2c_0x5F_indirect_function_table, 1, 1);
}

/* export: 'memory' */
wasm_rt_memory_t* w2c_0x24loop0x2Ewasm_memory(w2c_0x24loop0x2Ewasm* instance) {
  return &instance->w2c_memory;
}

/* export: '__wasm_call_ctors' */
void w2c_0x24loop0x2Ewasm_0x5F_wasm_call_ctors(w2c_0x24loop0x2Ewasm* instance) {
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE
#if !WASM_RT_SEGUE_FREE_SEGMENT
...
#endif
  w2c_0x24loop0x2Ewasm_0x5F_wasm_call_ctors_0(instance);
...
u32 w2c_0x24loop0x2Ewasm_0x5F_original_main(w2c_0x24loop0x2Ewasm* instance) {
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE
#if !WASM_RT_SEGUE_FREE_SEGMENT
  void* segue_saved_base = wasm_rt_segue_read_base();
#endif
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  u32 ret = w2c_0x24loop0x2Ewasm_0x5F_original_main_0(instance);
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE && !WASM_RT_SEGUE_FREE_SEGMENT
  wasm_rt_segue_write_base(segue_saved_base);
#endif
  return ret;
...
/* export: 'main' */
u32 w2c_0x24loop0x2Ewasm_main(w2c_0x24loop0x2Ewasm* instance, u32 var_p0, u32 var_p1) {
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE
#if !WASM_RT_SEGUE_FREE_SEGMENT
  void* segue_saved_base = wasm_rt_segue_read_base();
#endif
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  u32 ret = w2c_0x24loop0x2Ewasm_main_0(instance, var_p0, var_p1);
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE && !WASM_RT_SEGUE_FREE_SEGMENT
  wasm_rt_segue_write_base(segue_saved_base);
#endif
  return ret;
...
/* export: '__main_void' */
u32 w2c_0x24loop0x2Ewasm_0x5F_main_void(w2c_0x24loop0x2Ewasm* instance) {
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE
#if !WASM_RT_SEGUE_FREE_SEGMENT
  void* segue_saved_base = wasm_rt_segue_read_base();
#endif
...
wasm_rt_funcref_table_t* w2c_0x24loop0x2Ewasm_0x5F_indirect_function_table(w2c_0x24loop0x2Ewasm* instance) {
  return &instance->w2c_0x5F_indirect_function_table;
}

/* export: '__dso_handle' */
u32* w2c_0x24loop0x2Ewasm_0x5F_dso_handle(w2c_0x24loop0x2Ewasm* instance) {
  return &instance->w2c_0x5F_dso_handle;
}

/* export: '__data_end' */
u32* w2c_0x24loop0x2Ewasm_0x5F_data_end(w2c_0x24loop0x2Ewasm* instance) {
  return &instance->w2c_0x5F_data_end;
}

/* export: '__stack_low' */
u32* w2c_0x24loop0x2Ewasm_0x5F_stack_low(w2c_0x24loop0x2Ewasm* instance) {
  return &instance->w2c_0x5F_stack_low;
}

/* export: '__stack_high' */
u32* w2c_0x24loop0x2Ewasm_0x5F_stack_high(w2c_0x24loop0x2Ewasm* instance) {
  return &instance->w2c_0x5F_stack_high;
}

/* export: '__global_base' */
u32* w2c_0x24loop0x2Ewasm_0x5F_global_base(w2c_0x24loop0x2Ewasm* instance) {
  return &instance->w2c_0x5F_global_base;
}

/* export: '__heap_base' */
u32* w2c_0x24loop0x2Ewasm_0x5F_heap_base(w2c_0x24loop0x2Ewasm* instance) {
  return &instance->w2c_0x5F_heap_base;
}

/* export: '__heap_end' */
u32* w2c_0x24loop0x2Ewasm_0x5F_heap_end(w2c_0x24loop0x2Ewasm* instance) {
  return &instance->w2c_0x5F_heap_end;
}

/* export: '__memory_base' */
u32* w2c_0x24loop0x2Ewasm_0x5F_memory_base(w2c_0x24loop0x2Ewasm* instance) {
  return &instance->w2c_0x5F_memory_base;
}

/* export: '__table_base' */
u32* w2c_0x24loop0x2Ewasm_0x5F_table_base(w2c_0x24loop0x2Ewasm* instance) {
  return &instance->w2c_0x5F_table_base;
}

void wasm2c_0x24loop0x2Ewasm_instantiate(w2c_0x24loop0x2Ewasm* instance) {
...
void wasm2c_0x24loop0x2Ewasm_free(w2c_0x24loop0x2Ewasm* instance) {
  wasm_rt_free_funcref_table(&instance->w2c_0x5F_indirect_function_table);
  wasm_rt_free_memory(&instance->w2c_memory);
}

wasm_rt_func_type_t wasm2c_0x24loop0x2Ewasm_get_func_type(uint32_t param_count, uint32_t result_count, ...) {
  va_list args;
  ...
  if (param_count == 0 && result_count == 0) {
    ...
    if (true) {
      va_end(args);
      return w2c_0x24loop0x2Ewasm_t0;
    }
    va_end(args);
  }
  ...
  if (param_count == 0 && result_count == 1) {
    ...
    if (true && va_arg(args, int) == WASM_RT_I32) {
      va_end(args);
      return w2c_0x24loop0x2Ewasm_t1;
    }
    va_end(args);
  }
  ...
  if (param_count == 2 && result_count == 1) {
    ...
    if (true && va_arg(args, int) == WASM_RT_I32 && va_arg(args, int) == WASM_RT_I32 && va_arg(args, int) == WASM_RT_I32) {
      va_end(args);
      return w2c_0x24loop0x2Ewasm_t2;
    }
    va_end(args);
  }
...
void w2c_0x24loop0x2Ewasm_0x5F_wasm_call_ctors_0(w2c_0x24loop0x2Ewasm* instance) {
  FUNC_PROLOGUE;
  wasm_rt_consume_fuel(1);
  FUNC_EPILOGUE;
}

u32 w2c_0x24loop0x2Ewasm_0x5F_original_main_0(w2c_0x24loop0x2Ewasm* instance) {
  u32 var_l0 = 0;
  FUNC_PROLOGUE;
  wasm_rt_consume_fuel(1);
...
u32 w2c_0x24loop0x2Ewasm_main_0(w2c_0x24loop0x2Ewasm* instance, u32 var_p0, u32 var_p1) {
  FUNC_PROLOGUE;
  wasm_rt_consume_fuel(1);
  u32 var_i0;
  var_i0 = w2c_0x24loop0x2Ewasm_0x5F_original_main_0(instance);
  FUNC_EPILOGUE;
  return var_i0;
}
