...
static void w2c_0x24recursion0x2Ewasm_0x5F_wasm_call_ctors_0(w2c_0x24recursion0x2Ewasm*);
static u32 w2c_0x24recursion0x2Ewasm_main_0(w2c_0x24recursion0x2Ewasm*, u32);

FUNC_TYPE_T(w2c_0x24recursion0x2Ewasm_t0) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";
FUNC_TYPE_T(w2c_0x24recursion0x2Ewasm_t1) = "\x07\x80\x96\x7a\x42\xf7\x3e\xe6\x70\x5c\x2f\xac\x83\xf5\x67\xd2\xa2\xa0\x69\x41\x5f\xf8\xe7\x96\x7f\x23\xab\x00\x03\x5f\x4a\x3c";

static void init_globals(w2c_0x24recursion0x2Ewasm* instance) {
...
static void init_memories(w2c_0x24recursion0x2Ewasm* instance) {
  wasm_rt_allocate_memory(&instance->w2c_memory, 2, 65536, 0, 65536);
}

/* export: 'memory' */
wasm_rt_memory_t* w2c_0x24recursion0x2Ewasm_memory(w2c_0x24recursion0x2Ewasm* instance) {
  return &instance->w2c_memory;
}

/* export: '__wasm_call_ctors' */
void w2c_0x24recursion0x2Ewasm_0x5F_wasm_call_ctors(w2c_0x24recursion0x2Ewasm* instance) {
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE
#if !WASM_RT_SEGUE_FREE_SEGMENT
...
#endif
  w2c_0x24recursion0x2Ewasm_0x5F_wasm_call_ctors_0(instance);
...
/* export: 'main' */
u32 w2c_0x24recursion0x2Ewasm_main(w2c_0x24recursion0x2Ewasm* instance, u32 var_p0) {
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE
#if !WASM_RT_SEGUE_FREE_SEGMENT
  void* segue_saved_base = wasm_rt_segue_read_base();
#endif
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  u32 ret = w2c_0x24recursion0x2Ewasm_main_0(instance, var_p0);
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE && !WASM_RT_SEGUE_FREE_SEGMENT
  wasm_rt_segue_write_base(segue_saved_base);
#endif
  return ret;
...
/* export: '__dso_handle' */
u32* w2c_0x24recursion0x2Ewasm_0x5F_dso_handle(w2c_0x24recursion0x2Ewasm* instance) {
  return &instance->w2c_0x5F_dso_handle;
}

/* export: '__data_end' */
u32* w2c_0x24recursion0x2Ewasm_0x5F_data_end(w2c_0x24recursion0x2Ewasm* instance) {
  return &instance->w2c_0x5F_data_end;
}

/* export: '__stack_low' */
u32* w2c_0x24recursion0x2Ewasm_0x5F_stack_low(w2c_0x24recursion0x2Ewasm* instance) {
  return &instance->w2c_0x5F_stack_low;
}

/* export: '__stack_high' */
u32* w2c_0x24recursion0x2Ewasm_0x5F_stack_high(w2c_0x24recursion0x2Ewasm* instance) {
  return &instance->w2c_0x5F_stack_high;
}

/* export: '__global_base' */
u32* w2c_0x24recursion0x2Ewasm_0x5F_global_base(w2c_0x24recursion0x2Ewasm* instance) {
  return &instance->w2c_0x5F_global_base;
}

/* export: '__heap_base' */
u32* w2c_0x24recursion0x2Ewasm_0x5F_heap_base(w2c_0x24recursion0x2Ewasm* instance) {
  return &instance->w2c_0x5F_heap_base;
}

/* export: '__heap_end' */
u32* w2c_0x24recursion0x2Ewasm_0x5F_heap_end(w2c_0x24recursion0x2Ewasm* instance) {
  return &instance->w2c_0x5F_heap_end;
}

/* export: '__memory_base' */
u32* w2c_0x24recursion0x2Ewasm_0x5F_memory_base(w2c_0x24recursion0x2Ewasm* instance) {
  return &instance->w2c_0x5F_memory_base;
}

/* export: '__table_base' */
u32* w2c_0x24recursion0x2Ewasm_0x5F_table_base(w2c_0x24recursion0x2Ewasm* instance) {
  return &instance->w2c_0x5F_table_base;
}

void wasm2c_0x24recursion0x2Ewasm_instantiate(w2c_0x24recursion0x2Ewasm* instance) {
...
void wasm2c_0x24recursion0x2Ewasm_free(w2c_0x24recursion0x2Ewasm* instance) {
  wasm_rt_free_memory(&instance->w2c_memory);
}

wasm_rt_func_type_t wasm2c_0x24recursion0x2Ewasm_get_func_type(uint32_t param_count, uint32_t result_count, ...) {
  va_list args;
  ...
  if (param_count == 0 && result_count == 0) {
    ...
    if (true) {
      va_end(args);
      return w2c_0x24recursion0x2Ewasm_t0;
    }
    va_end(args);
  }
  ...
  if (param_count == 1 && result_count == 1) {
    ...
    if (true && va_arg(args, int) == WASM_RT_I32 && va_arg(args, int) == WASM_RT_I32) {
      va_end(args);
      return w2c_0x24recursion0x2Ewasm_t1;
    }
    va_end(args);
  }
...
void w2c_0x24recursion0x2Ewasm_0x5F_wasm_call_ctors_0(w2c_0x24recursion0x2Ewasm* instance) {
  FUNC_PROLOGUE;
  wasm_rt_consume_fuel(1);
  FUNC_EPILOGUE;
}

u32 w2c_0x24recursion0x2Ewasm_main_0(w2c_0x24recursion0x2Ewasm* instance, u32 var_p0) {
  ...
  var_L1: 
    ...
    var_i1 = 4294967295u;
    var_i0 += var_i1;
    var_i0 = w2c_0x24recursion0x2Ewasm_main_0(instance, var_i0);
    var_l2 = var_i0;
    var_i0 = var_l1;
    var_i1 = var_l1;
