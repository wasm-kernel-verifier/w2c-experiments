...
static u32 w2c_add_add_0(w2c_add*, u32, u32);

FUNC_TYPE_T(w2c_add_t0) = "\x92\xfb\x6a\xdf\x49\x07\x0a\x83\xbe\x08\x02\x68\xcd\xf6\x95\x27\x4a\xc2\xf3\xe5\xe4\x7d\x29\x49\xe8\xed\x42\x92\x6a\x9d\xda\xf0";

/* export: 'add' */
u32 w2c_add_add(w2c_add* instance, u32 var_p0, u32 var_p1) {
  u32 ret = w2c_add_add_0(instance, var_p0, var_p1);
  return ret;
}

void wasm2c_add_instantiate(w2c_add* instance) {
