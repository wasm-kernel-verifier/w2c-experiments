...
static void w2c_memfunc_0x5F_wasm_call_ctors_0(w2c_memfunc*);
static u32 w2c_memfunc_memfunc_0(w2c_memfunc*, u32);

FUNC_TYPE_T(w2c_memfunc_t0) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";
FUNC_TYPE_T(w2c_memfunc_t1) = "\x07\x80\x96\x7a\x42\xf7\x3e\xe6\x70\x5c\x2f\xac\x83\xf5\x67\xd2\xa2\xa0\x69\x41\x5f\xf8\xe7\x96\x7f\x23\xab\x00\x03\x5f\x4a\x3c";

static void init_globals(w2c_memfunc* instance) {
...
static void init_memories(w2c_memfunc* instance) {
...
void w2c_memfunc_0x5F_wasm_call_ctors(w2c_memfunc* instance) {
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE
#if !WASM_RT_SEGUE_FREE_SEGMENT
...
#endif
  w2c_memfunc_0x5F_wasm_call_ctors_0(instance);
...
/* export: 'memfunc' */
u32 w2c_memfunc_memfunc(w2c_memfunc* instance, u32 var_p0) {
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE
#if !WASM_RT_SEGUE_FREE_SEGMENT
  void* segue_saved_base = wasm_rt_segue_read_base();
#endif
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  u32 ret = w2c_memfunc_memfunc_0(instance, var_p0);
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE && !WASM_RT_SEGUE_FREE_SEGMENT
  wasm_rt_segue_write_base(segue_saved_base);
#endif
  return ret;
...
void wasm2c_memfunc_instantiate(w2c_memfunc* instance) {
...
void wasm2c_memfunc_free(w2c_memfunc* instance) {
...
void w2c_memfunc_0x5F_wasm_call_ctors_0(w2c_memfunc* instance) {
  FUNC_PROLOGUE;
  wasm_rt_consume_fuel(1);
  FUNC_EPILOGUE;
}

u32 w2c_memfunc_memfunc_0(w2c_memfunc* instance, u32 var_p0) {
  u32 var_l1 = 0;
  FUNC_PROLOGUE;
  wasm_rt_consume_fuel(1);
